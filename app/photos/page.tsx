      ...
      <SectionTwoColumns
        left={
          <SectionBlocText
            ...
            description={
              <>
                Nous avons confié le soin à
                <a className="bg-nude px-2 rounded-xl w-max" href="https://www.paulinecollusphotography.com/">
                  @PaulineCollus
                </a>
                d’immortaliser cette merveilleuse journée. Nous vous partagerons les photos qu’elle aura prise
                sur ce site.
              </>
            }
            cta={
          ...
          <SectionBlocText
            ...
            cta={
              <div className="flex space-x-2">
                <a className="flex" rel="nofollow" href="https://apps.apple.com/fr/app/wedshoots/id660256196">
                  <Image
                    width={150}
                    height={60}
                    alt="App Store"
